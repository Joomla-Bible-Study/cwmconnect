...
abstract class JHtmlContact
{
	...
	static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states	= array(
			0	=> array('disabled.png', 'contacts.featured', 'COM_CHURCHDIRECTORY_UNFEATURED', 'COM_CHURCHDIRECTORY_TOGGLE_TO_FEATURE'),
			1	=> array('featured.png', 'contacts.unfeatured', 'JFEATURED', 'COM_CHURCHDIRECTORY_TOGGLE_TO_UNFEATURE'),
		);
