...
<head>
  ...
  <?php if ($less==1) ?><link rel="stylesheet/less" type="text/css" href="<?php echo $tpath; ?>/css/template.less">
  <?php if ($less==1 && $bootstrap==1) ?><link rel="stylesheet/css" type="text/css" href="<?php echo $tpath; ?>/css/bootstrap-responsive.min.css">  
