	...
	if (is_array($items))
	{
		...
		if (!$itemid)
		{
			foreach ($items as $item)
			{
				...
				elseif (isset($item->query['view']) && $item->query['view'] == 'directory'
						&& isset($query['view']) && $query['view'] == 'directory'
						&& isset($item->query['catid']) && $item->query['catid'] == $query['catid'])
				{
					$itemid	= $item->id;
				}
				elseif (isset($item->query['view']) && $item->query['view'] == 'printdirectory'
						&& isset($query['view']) && $query['view'] == 'printdirectory'
						&& isset($item->query['catid']) && $item->query['catid'] == $query['catid'])
				{
					$itemid	= $item->id;
				}
...
function QContactsParseRoute($segments)
{
	...
	if (is_object($item))
	{
		...
		elseif (isset($item->query['view']) && $item->query['view'] == 'section' && count($segments) == 2)
		...
		elseif (isset($item->query['view']) && $item->query['view'] == 'section' && isset($segments[0]))
