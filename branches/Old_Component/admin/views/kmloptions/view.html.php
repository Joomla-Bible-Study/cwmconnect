...
class QContactsViewKMLOptions extends JViewLegacy {
    function display($tpl = null) {
		...
		$lists['catid'] = JHTML::_('list.category',  'filter_catid', 'com_qcontacts_kmloptions', intval($filter_catid), $javascript);
