...
class com_churchdirectoryInstallerScript
{
	 ...
	 * @var array
	 */
	private $installation_queue = array(// modules => { (folder) => { (module) => { (position), (published) } }* }*
		'modules' => array('admin' => array(), 'site' => array('birthdayanniversary' => 0,)), // plugins => { (folder) => { (element) => (published) }* }*
		'plugins' => array('finder' => array('finder_churchdirectory' => 1,), 'search' => array('search_churchdirectory' => 0,),), // template => { (folder) => { (element) => (published) }* }*
		'template' => array('admin' => array(), 'site' => array('churchdirectory_print' => 1,),));
	 ...
	 * @var array
	 */
	private $param_array = array('protectedaccess' => "8", "churchdirectory_layout" => "_:default", "show_churchdirectory_category" => "hide", "show_churchdirectory_list" => "0", "presentation_style" => "sliders", "show_address_full" => "0", "show_name" => "1", "show_position" => "1", "show_email" => "1", "show_street_address" => "1", "show_suburb" => "1", "show_state" => "1", "show_postcode" => "1", "show_country" => "1", "show_telephone" => "1", "show_mobile" => "1", "show_fax" => "1", "show_webpage" => "1", "show_misc" => "1", "show_image" => "1", "image" => "", "allow_vcard" => "0", "show_articles" => "1", "show_profile" => "1", "show_links" => "1", "linka_name" => "", "linkb_name" => "", "linkc_name" => "", "linkd_name" => "", "linke_name" => "", "churchdirectory_icons" => "0", "icon_address" => "", "icon_email" => "", "icon_telephone" => "", "icon_mobile" => "", "icon_fax" => "", "icon_misc" => "", "category_layout" => "_:default", "show_category_title" => "1", "show_description" => "1", "show_description_image" => "0", "maxLevel" => "-1", "show_empty_categories" => "0", "show_subcat_desc" => "1", "show_cat_items" => "1", "show_base_description" => "1", "maxLevelcat" => "-1", "show_empty_categories_cat" => "0", "show_subcat_desc_cat" => "1", "show_cat_items_cat" => "1", "show_pagination_limit" => "1", "show_headings" => "1", "show_position_headings" => "1", "show_email_headings" => "1", "show_telephone_headings" => "1", "show_mobile_headings" => "0", "show_fax_headings" => "0", "show_suburb_headings" => "0", "show_state_headings" => "0", "show_country_headings" => "0", "show_pagination" => "2", "show_pagination_results" => "1", "initial_sort" => "ordering", "directory_layout" => "_:default", "dr_presentation_style" => "sliders", "dr_churchdirectory_icons" => "0", "dr_show_address_full" => "0", "show_page_title" => "1", "dr_show_position" => "1", "dr_show_email" => "1", "dr_show_street_address" => "1", "dr_show_suburb" => "1", "dr_show_state" => "1", "dr_show_postcode" => "1", "dr_show_country" => "1", "dr_show_telephone" => "1", "dr_show_mobile" => "1", "dr_show_fax" => "1", "dr_show_webpage" => "1", "dr_show_misc" => "1", "dr_show_spouse" => "1", "dr_show_children" => "1", "dr_show_image" => "1", "dr_image" => "", "dr_allow_kml" => "1", "dr_show_articles" => "1", "dr_show_profile" => "1", "dr_show_links" => "1", "dr_linka_name" => "", "dr_linkb_name" => "", "dr_linkc_name" => "", "dr_linkd_name" => "", "dr_linke_name" => "", "rows_per_page" => "3", "items_per_row" => "2", "dinitial_sort" => "lname", "dr_show_debug" => "0", "show_email_form" => "1", "show_email_copy" => "1", "banned_email" => "", "banned_subject" => "", "banned_text" => "", "validate_session" => "1", "custom_reply" => "0", "redirect" => "", "show_feed_link" => "1", "sef_advanced_link" => "0",);
	...
	private function setParams()
	{
		if (count($this->param_array) > 0) {
			...
			$db->setQuery('UPDATE #__extensions SET params = ' . $db->quote($paramsString) . ' WHERE name = ' . $db->quote('com_churchdirectory'));
			$db->query();
		}
	}
	...
	private function setDefaultDB()
	{
		...
		$catData = array('id' => 0, 'parent_id' => 0, 'level' => 1, 'path' => 'default-team', 'extension' => 'com_churchdirectory', 'title' => 'Default Team', 'alias' => 'default-team', 'description' => '<p>Default Team where members are assigned if non are specified.</p>', 'published' => 1, 'language' => '*');
		$status = $catmodel->save($catData);

		if (!$status) {
			JError::raiseWarning(500, JText::_('Unable to create default ChurchDirectory category!'));
		}
