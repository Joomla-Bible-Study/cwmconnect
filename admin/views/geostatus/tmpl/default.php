...
<table class="adminlist table table-striped" id="articleList">
    ...
    <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
        ...
        <td class="center">
			<?php echo JHtml::_('jgrid.published', $item->published, $i, 'geostatus.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
        </td>
        <td class="nowrap has-context">
            <div class="pull-left">
				<?php if ($item->checked_out) : ?>
				<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'geostatus.', $canCheckin); ?>
				<?php endif; ?>
