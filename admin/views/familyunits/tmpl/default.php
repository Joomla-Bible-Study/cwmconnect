...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_churchdirectory&task=familyunits.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'familyunitsList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_churchdirectory&view=familyunits'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<?php else : ?>
				<table class="table table-striped" id="familyunitsList">
					<thead>
					<tr>
