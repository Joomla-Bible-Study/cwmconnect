...
<div class="modal hide fade" id="collapseModal">
    <div class="modal-header">
        ...
        <h3><?php echo JText::_('COM_CHURCHDIRECTORY_BATCH_OPTIONS_POSITION');?></h3>
    </div>
    <div class="modal-body">
        <p><?php echo JText::_('COM_CHURCHDIRECTORY_BATCH_TIP_POSITION'); ?></p>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('position.batch');">
