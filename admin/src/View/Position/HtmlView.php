...
use CWM\Component\Churchdirectory\Administrator\Model\PositionModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(
            $isNew
                ? Text::_('COM_CHURCHDIRECTORY_MANAGER_POSITION_NEW')
                : Text::_('COM_CHURCHDIRECTORY_MANAGER_POSITION_EDIT'),
            'churchdirectory'
        );
