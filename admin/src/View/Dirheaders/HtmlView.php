...
/**
 * View class for a list of Dirheaders.
 *
 * @since  2.0.0
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        if ($canDo->get('core.edit') || $canDo->get('core.edit.own')) {
            $toolbar->edit('dirheader.edit')->listCheck(true);
        }
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            $childBar->publish('dirheaders.publish')->listCheck(true);
            $childBar->unpublish('dirheaders.unpublish')->listCheck(true);
            $childBar->archive('dirheaders.archive')->listCheck(true);
            $childBar->checkin('dirheaders.checkin')->listCheck(true);

            if ((int) $this->state->get('filter.published') !== -2) {
                $childBar->trash('dirheaders.trash')->listCheck(true);
            }
        }
        ...
        if ((int) $this->state->get('filter.published') === -2 && $canDo->get('core.delete')) {
            $toolbar->delete('dirheaders.delete', 'JTOOLBAR_EMPTY_TRASH')
