...
namespace CWM\Component\Cwmconnect\Administrator\View\Familyunit;

// phpcs:disable PSR1.Files.SideEffects
\defined('_JEXEC') or die;
// phpcs:enable PSR1.Files.SideEffects

use CWM\Component\Cwmconnect\Administrator\Model\FamilyunitModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        if ($isNew) {
            ...
            ToolbarHelper::cancel('familyunit.cancel');
        } else {
            if (!$checkedOut) {
            ...
            if ($canDo->get('core.create')) {
                ToolbarHelper::save2copy('familyunit.save2copy');
            }

            ToolbarHelper::cancel('familyunit.cancel', 'JTOOLBAR_CLOSE');
        }
