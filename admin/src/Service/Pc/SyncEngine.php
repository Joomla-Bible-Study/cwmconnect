 ...
 *                          the injected logger.
 *
 * Phase C scope: people + status filter only. Custom fields / photos /
 * relationship fan-out (household, campus) defer to D / E.
 *
...
final class SyncEngine
{
    ...
    /**
     * Includes we pass to PC. Households and primary_campus stay in scope per
     * spec §5.3 so the fetch shape is stable for Phase D's relationship
     * resolver — but the values aren't consumed in this phase.
     *
     * @since  __DEPLOY_VERSION__
     */
    private const PEOPLE_INCLUDES = 'emails,phone_numbers,addresses,households,primary_campus';

    /**
     * Constructor.
     *
     * @param   Client                       $client      Authenticated PC client.
     * @param   MemberRepositoryInterface    $repository  Persistence layer.
