...
/**
 * Dirheader form controller.
 *
 * @since  2.0.0
 */
class DirheaderController extends FormController
{
    /**
    ...
    public function batch($model = null): bool
    {
        ...
        $this->setRedirect(
            Route::_(
                'index.php?option=com_churchdirectory&view=dirheaders' . $this->getRedirectToListAppend(),
                false
            )
        );
