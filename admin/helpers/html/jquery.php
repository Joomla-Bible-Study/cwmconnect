...
abstract class JHtmlJquery
{
	...
	public static function framework($noConflict = true, $debug = null)
	{
		...
		JHtml::_('script', $url . 'jui/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			JHtml::_('script', $url . 'jui/jquery-noconflict.js', false, true, false, false, false);
		}
	...
	public static function ui(array $components = array('core'), $debug = null)
	{
		...
		foreach ($components as $component)
		{
			...
			{
				JHtml::_('script', $url . 'jui/jquery.ui.' . $component . '.min.js', false, true, false, false, $debug);
