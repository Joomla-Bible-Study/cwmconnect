...
{
	JLoader::register('JLayoutHelper', JPATH_COMPONENT_ADMINISTRATOR . '/helpers/layout/helper.php');
	JLoader::register('JLayoutFile', JPATH_COMPONENT_ADMINISTRATOR . '/helpers/layout/file.php');
	JLoader::register('JLayoutBase', JPATH_COMPONENT_ADMINISTRATOR . '/helpers/layout/base.php');
	JLoader::register('JLayout', JPATH_COMPONENT_ADMINISTRATOR . '/helpers/layout/layout.php');
}
...
abstract class JHtmlBootstrap
{
	...
	public static function affix($selector = 'affix', $params = array())
	{
		...
		if (!isset(static::$loaded[__METHOD__][$sig]))
		{
			...
			$options = static::getJSObject($opt);
