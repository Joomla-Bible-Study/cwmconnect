...
/** @var \CWM\Component\Cwmconnect\Administrator\View\Positions\HtmlView $this */
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_cwmconnect&task=positions.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}
?>
<form action="<?php echo Route::_('index.php?option=com_cwmconnect&view=positions'); ?>" method="post"
            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table" id="positionList">
                        <caption class="visually-hidden"><?php echo Text::_('COM_CWMCONNECT_MANAGER_POSITIONS'); ?></caption>
                        <thead>
                            <tr>
                                ...
                                <?php if ($assoc) : ?>
                                    <th scope="col" class="w-5 d-none d-md-table-cell">
                                        <?php echo HTMLHelper::_('searchtools.sort', 'COM_CWMCONNECT_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
                                    </th>
                                <?php endif; ?>
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
                                ...
                                <td>
                                    ...
                                    <?php if ($canEdit || $canEditOwn) : ?>
                                        <a href="<?php echo Route::_('index.php?option=com_cwmconnect&task=position.edit&id=' . (int) $item->id); ?>">
