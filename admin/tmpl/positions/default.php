...
/** @var \CWM\Component\Churchdirectory\Administrator\View\Positions\HtmlView $this */
...
if ($saveOrder && !empty($this->items)) {
    $saveOrderingUrl = 'index.php?option=com_churchdirectory&task=positions.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
    HTMLHelper::_('draggablelist.draggable');
}
?>
<form action="<?php echo Route::_('index.php?option=com_churchdirectory&view=positions'); ?>" method="post"
            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table" id="positionList">
                        <caption class="visually-hidden"><?php echo Text::_('COM_CHURCHDIRECTORY_MANAGER_POSITIONS'); ?></caption>
                        <thead>
                            <tr>
                                ...
                                <?php if ($assoc) : ?>
                                    <th scope="col" class="w-5 d-none d-md-table-cell">
                                        <?php echo HTMLHelper::_('searchtools.sort', 'COM_CHURCHDIRECTORY_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
                                    </th>
                                <?php endif; ?>
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
                                ...
                                <td class="text-center">
                                    <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'positions.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                                </td>
                                <td>
                                    ...
                                    <?php if ($canEdit || $canEditOwn) : ?>
                                        <a href="<?php echo Route::_('index.php?option=com_churchdirectory&task=position.edit&id=' . (int) $item->id); ?>">
                                ...
                                <?php if ($assoc) : ?>
                                    <td class="d-none d-md-table-cell">
                                        <?php if (!empty($item->association)) : ?>
                                            <?php echo HTMLHelper::_('positions.association', $item->id); ?>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                                <?php if (Multilanguage::isEnabled()) : ?>
                                    <td class="small d-none d-md-table-cell">
                                        ...
                                        <?php else : ?>
                                            <?php echo $item->language_title ?: Text::_('JUNDEFINED'); ?>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                                <td class="text-center d-none d-md-table-cell">
