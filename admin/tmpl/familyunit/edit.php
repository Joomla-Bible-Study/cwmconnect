...
/** @var \CWM\Component\Cwmconnect\Administrator\View\Familyunit\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_cwmconnect&view=familyunit&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="main-card">
                        ...
                        <?php if (!empty($this->members)) : ?>
                            <?php foreach ($this->members as $member) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->escape($member->name) ?: 'ID: ' . (int) $member->id; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'familyunitTab', 'publishing', Text::_('JGLOBAL_FIELDSET_PUBLISHING')); ?>
        <div class="row">
            <div class="col-lg-6">
