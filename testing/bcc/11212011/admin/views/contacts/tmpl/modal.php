...
?>
<form action="<?php echo JRoute::_('index.php?option=com_churchdirectory&view=contacts&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
