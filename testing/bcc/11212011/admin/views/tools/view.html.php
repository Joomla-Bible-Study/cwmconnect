...
class ChurchDirectoryViewTools extends JView{
        ...
        protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CHURCHDIRECTORY_MANAGER_CPANE'), 'contact.png');

			JToolBarHelper::preferences('com_churchdirectory');
			JToolBarHelper::divider();

		JToolBarHelper::help('churchdirectory_tools', TRUE);
        }
}