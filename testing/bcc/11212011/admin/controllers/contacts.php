 ...
 * @since	1.6
 */
class ChurchDirectoryControllerContacts extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	...
	function featured()
	{
		...
		$this->setRedirect('index.php?option=com_churchdirectory&view=contacts');
	}
