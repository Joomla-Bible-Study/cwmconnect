...
<form action="<?php echo JRoute::_('index.php?option=com_churchdirectory&view=kmls'); ?>" method="post" name="adminForm" id="adminForm">
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        <?php if ($item->checked_out) : ?>
                            <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'kmls.', $canCheckin); ?>
                        <?php endif; ?>
                        <?php if ($canEdit || $canEditOwn) : ?>
                            <a href="<?php echo JRoute::_('index.php?option=com_churchdirectory&task=kml.edit&id=' . (int) $item->id); ?>">
