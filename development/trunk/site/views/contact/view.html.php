...
class ChurchDirectoryViewContact extends JView {
	function display($tpl = null)
	{
		...
		$params = &$mainframe->getParams('com_churchdirectory');
		...
		switch ($params->get('contact_icons'))	{
			...
			default :
				...
				$image7 = JHTML::_('image.site', 'skype.png', '/components/com_churchdirectory/images/', $params->get('icon_skype'), '/components/com_churchdirectory/images/', JText::_('Skype').": ");
				$image8 = JHTML::_('image.site', 'yahoo.gif', '/components/com_churchdirectory/images/', $params->get('icon_yahoo'), '/components/com_churchdirectory/images/', JText::_('Yahoo Messenger').": ");
		...
		if($params->get('show_captcha')) {
			$params->set('captcha', JHTML::image('index.php?option=com_churchdirectory&amp;controller=captcha&amp;id='.$contact->id.'&amp;format=raw&amp;sid=' . md5(uniqid(time())), 'captcha',array('id'=>'captcha-img')));
		} else {
			$params->set('captcha','');
		}
		$fields = array();
		...
		JHTML::stylesheet('churchdirectory.css', 'components/com_churchdirectory/css/');
