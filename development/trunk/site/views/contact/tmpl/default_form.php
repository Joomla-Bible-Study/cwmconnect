...
<?php if($this->error) { ?>
<div id="churchdirectory-error">
<?php echo $this->error; ?>
</div>
<?php } ?>
<form action="<?php echo JRoute::_( 'index.php?option=com_churchdirectory&view=contact&id='.$this->contact->slug.'&catid='.$this->contact->catslug );?>" method="post" name="emailForm" id="emailForm" class="form-validate" onsubmit="return validateForm(this);">
	<div class="churchdirectory_email<?php echo $this->params->get('pageclass_sfx'); ?>">
		<?php
		$i=0;
