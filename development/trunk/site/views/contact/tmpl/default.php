...
<?php } ?>
<div id="churchdirectory<?php echo $this->params->get('pageclass_sfx'); ?>">
...
<?php if($this->params->get('allow_vcard')) { ?>
	<p>
		...
		<a href="index.php?option=com_churchdirectory&amp;controller=vcard&amp;contact_id=<?php echo $this->contact->id; ?>&amp;format=raw">
