...
class ChurchDirectoryControllerVCard extends ChurchDirectoryController {
	function display() {
		global $mainframe;
		...
		JTable::addIncludePath(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_churchdirectory'.DS.'tables');
		...
		if ($vc)
		{
			...
			require_once(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_churchdirectory'.DS.'helpers'.DS.'vcard.php');
			$v = new JvCard();
