    ...
    <?php foreach ($group_members as $contact) { ?>
        ...
        <div class="contact<?php echo $contact->odd + 1; ?>">
            ...
            foreach ($this->columns as $col) {
                ...
                if ($c->field == 'image') {
                    if ($contact->{$c->field} == '') {
                        echo '<img src="' . $this->baseurl . '/images/members/1st_church_8x12.jpg" hspace="6" alt="No Image Avalible" width="100px" />';
                    } else {
                        echo '<img src="' . $this->baseurl . '/images/members/' . $contact->{$c->field} . '" hspace="6" alt="image" width="100px" />';
                    }
                    echo ('<span>');
                    ...
                    if ($contact->con_position == '') {
                        ...
                        echo '<b>Position:</b> ' . $contact->con_p;
                        osition . '<br />';
                    }
                    if ($contact->address == '') {
                    ...
                    if ($contact->postcodeaddon == '') {
                        echo '<br /><br />';
                    } else {
                        echo '-' . $contact->postcodeaddon . '<br /><br />';
                    }
