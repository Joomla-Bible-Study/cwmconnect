...
<div id="qcontacts-confirm<?php echo $this->params->get('pageclass_sfx'); ?>">
<?php echo JText::_('CONFIRMATION_MESSAGE'); ?>
<span class="linkback">
<a href="<?php echo JRoute::_('index.php?option=com_qcontacts&view=contact&id='.$this->contact->slug.'&catid='.$this->contact->catslug, false);?>"><?php echo JText::_('Go Back'); ?></a>
</span>
</div>
