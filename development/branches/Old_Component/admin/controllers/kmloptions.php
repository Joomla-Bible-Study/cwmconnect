...
class QContactsControllerKMLOptionsa extends QContactsController {
	...
	function save() {
		...
		switch($this->getTask()) {
			case 'apply':
				...
				$link	= 'index.php?option=com_qcontacts&controller=kmloptions&task=edit&cid[]='. $model->getState('rid') .'';
				break;
			case 'save':
			default:
				$msg	= JText::_( 'KML Options saved' );
				$link	= 'index.php?option=com_qcontacts&view=kmloptoins';
				break;
		}
	...
	function remove() {
		...
		$this->setRedirect('index.php?option=com_qcontacts&view=kmloptoins', JText::_( 'KML Options(s) removed' ));
	}
	...
	function publish() {
		...
		$this->setRedirect('index.php?option=com_qcontacts&view=kmloptoins');
	}
	...
	function saveorder() {
		...
		$this->setRedirect('index.php?option=com_qcontacts&view=kmloptoins', JText::_('New ordering saved'));
	}
}
?>