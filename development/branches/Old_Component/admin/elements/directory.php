...
class JElementDirectory extends JElement {
	...
	function fetchElement($name, $value, &$node, $control_name) {
		...
		$query = 'SELECT a.id, CONCAT( a.name, " - ",a.con_position ) AS text, a.lname '
		...
		return JHTML::_('select.genericlist',  $options, ''.$control_name.'['.$lname.']', 'class="inputbox"', 'id', 'text', $value, $control_name.$lname );
	}
}
