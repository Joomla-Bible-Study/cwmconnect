...
<div class="churchdirectory_model_wrapper cd_margin_top_20">
    <?php if ($birthdays) : ?>
        ...
        <table style="width: 100%">
            <tr>
                <th class="churchdirectory_model_theder"><?php echo Text::_('COM_BIRTHDAYANNIVERSARY_DAY'); ?></th>
                <th class="churchdirectory_model_theder"><?php echo Text::_('COM_BIRTHDAYANNIVERSARY_MEMBER_NAME'); ?></th>
            </tr>
            <?php foreach ($birthdays as $bday) : ?>
                <tr>
                    <td class="churchdirectory_model_row"><?php echo $bday['day']; ?></td>
                    <td class="churchdirectory_model_row"><?php echo $this->escape($bday['name']); ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
    <?php endif; ?>
        ...
        <table style="width: 100%">
            ...
            <?php foreach ($anniversary as $annday) : ?>
                <tr>
                    ...
                    <td class="churchdirectory_model_row"><?php echo $this->escape($annday['name']); ?></td>
                </tr>
            <?php endforeach; ?>
        </table>
    <?php endif; ?>
