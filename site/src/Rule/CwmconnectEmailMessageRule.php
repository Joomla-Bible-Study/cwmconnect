...
namespace CWM\Component\Cwmconnect\Site\Rule;
 ...
 * @since  2.0.0
 */
class CwmconnectEmailMessageRule extends FormRule
{
    public function test(\SimpleXMLElement $element, $value, $group = null, ?Registry $input = null, ?Form $form = null): bool
    {
        $banned = (string) ComponentHelper::getParams('com_cwmconnect')->get('banned_text', '');
