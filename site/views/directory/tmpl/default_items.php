            ...
            <tr>
                <td width="100">
						...
						if ($item->funit_image && $this->params->get('dr_show_image')) :
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $item->funit_image . '" alt="' .
								$item->funit_name . '" style="'  .  $dir_img . '" />';
                        elseif ($this->params->get('image') != null && $this->params->get('dr_show_image')):
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $this->params->get('image') . '" alt="' .
								JText::_('COM_CHURCHDIRECTORY_NO_PHOTO_AVALIBLE') . '" style="'  .  $dir_img . '" />';
                        elseif ($this->params->get('dr_show_image')):
							echo '<img src="' . $this->baseurl . '/media/com_churchdirectory/images/200-photo_not_available.jpg" alt="' .
								JText::_('COM_CHURCHDIRECTORY_NO_PHOTO_AVALIBLE') . '" style="'  .  $dir_img . '" />';
						endif;
						?>
                </td>
            ...
            <tr>
                ...
                <?php
						if ($item->image && $this->params->get('dr_show_image')) :
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $item->image . '" alt="' .
								$item->name . '" style="'  .  $dir_img . '" />';
                        elseif ($this->params->get('image') != null && $this->params->get('dr_show_image')):
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $this->params->get('image') . '" alt="' .
								JText::_('COM_CHURCHDIRECTORY_NO_PHOTO_AVALIBLE') . '" style="'  .  $dir_img . '" />';
                        elseif ($this->params->get('dr_show_image')):
