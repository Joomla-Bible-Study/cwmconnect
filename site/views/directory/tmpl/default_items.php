				...
				<tr>
					<td class="cd-image">
						...
						if ($item->funit_image && $this->params->get('dr_show_image')) :
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $item->funit_image . '" width="200" align="middle" alt="' .
								$item->funit_name . '" class="directory-img" />';
						elseif ($this->params->get('image') != null && $this->params->get('dr_show_image')):
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $this->params->get('image') . '" width="200" align="middle" alt="' .
								JText::_('COM_CHURCHDIRECTORY_NO_PHOTO_AVALIBLE') . '" class="directory-img" />';
						elseif ($this->params->get('dr_show_image')):
							echo '<img src="' . $this->baseurl . '/media/com_churchdirectory/images/200-photo_not_available.jpg" width="200" align="middle" alt="' .
								JText::_('COM_CHURCHDIRECTORY_NO_PHOTO_AVALIBLE') . '" class="directory-img" />';
						endif;
						?>
					</td>
				...
				<tr>
					<td class="cd-image">
						...
						if ($item->image && $this->params->get('dr_show_image')) :
							echo '<img src="' . $this->baseurl . DIRECTORY_SEPARATOR . $item->image . '" width="200" align="middle" alt="' .
