...
<?php if ($this->params->get('presentation_style') == 'tabs'): ?>
	<ul class="nav nav-tabs" id="myTab">
		...
		<?php if ($this->params->get('show_email_form') && ($this->member->email_to || $this->member->user_id)) : ?>
			<li><a data-toggle="tab" href="#display-form"><?php echo JText::_('COM_CHURCHDIRECTORY_EMAIL_FORM'); ?></a>
			</li><?php endif; ?>
		...
		<?php if ($this->params->get('show_profile') && $this->member->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
			<li><a data-toggle="tab" href="#display-profile"><?php echo JText::_('COM_CHURCHDIRECTORY_PROFILE'); ?></a>
			</li><?php endif; ?>
...
<?php if ($this->params->get('show_email_form') && !empty($this->member->email_to)) : ?>

	<?php if ($this->params->get('presentation_style') == 'sliders'): ?>
		<?php echo JHtml::_('bootstrap.addSlide', 'slide-contact', JText::_('COM_CHURCHDIRECTORY_EMAIL_FORM'), 'display-form'); ?>
	<?php endif; ?>
	<?php if ($this->params->get('presentation_style') == 'tabs'): ?>
		<?php echo JHtml::_('bootstrap.addPanel', 'myTab', 'display-form', JText::_('COM_CHURCHDIRECTORY_EMAIL_FORM', true)); ?>
	<?php endif; ?>
	<?php if ($this->params->get('presentation_style') == 'plain'): ?>
